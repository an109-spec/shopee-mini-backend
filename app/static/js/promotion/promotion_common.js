...
<input type="checkbox" name="variant_ids[]" value="${productId}"data-price="0"
data-stock="0">
...
if(originPrice){
if(min===max)
originPrice.value = min
else
originPrice.value = `${min} - ${max}`
}
...
box.querySelectorAll("input[name='variant_ids[]']")
.forEach(v => {
    v.checked = true
